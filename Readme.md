...
You can set the env variable `QUICK_BUILD=1` or append `--arg quickBuild true` to the nix-build argument list for a faster development build (lower compression).
