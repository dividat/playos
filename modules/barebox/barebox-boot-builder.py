...
# Addapted from systemd-boot-builder.py in nixpkgs
...
def write_entry(profile, generation, machine_id = None):
...
def main():
    parser = argparse.ArgumentParser(description='Update NixOS-related barebox boot files')
